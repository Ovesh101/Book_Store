...
const BookSingleComponents = ({book , id}) => {
    const [showModel , setShowModel] = useState(false);
  return (
    <div key={id} className="border-2 border-gray-500 rounded-lg px-4 py-2 m-4 relative hover:shadow-xl">
                <h2 className="absolute top-1 right-2 px-4 py-1 rounded-lg bg-red-300">{book.publishedYear}</h2>
...
export default BookSingleComponents